  ...
  <div id="login">
    <div class="top center">
		...
		<div class="login">
			...
			<div class="login_center">
				<div class="login_top">
					...
					<div class="right fr">您还不是我们的会员？<a  target="_self" @click="register">立即注册    </a><a @click="index" target="_self">主页</a></div>
					<div class="clear"></div>
					<div class="xian center"></div>
				</div>
				<div class="login_main center">
					<div class="username">用户名:&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名" v-model="username"/></div>
					<div class="username">密&nbsp;&nbsp;&nbsp;&nbsp;码:&nbsp;<input class="shurukuang" type="password" name="password" placeholder="请输入你的密码" v-model="password"/></div>
					<!-- <div class="username">
		...
		<footer>
			...
			<div class="copyright">版权所有-京ICP备10046444-<img src="./image/ghs.png" alt="">京公网安备11010802020134号-京ICP证110507号</div>
...
export default {
  ...
  methods:{
	...
	index(){
	  ...
	  login(){
		  axios.post('/users/api-token-auth/', {'username': this.username, 'password': this.password})
		  .then((result)=>{
...
.form{width: 100%;height:450px;background: url('./image/222.png') 110px 0px no-repeat;background-color:rgb(247, 247, 255);}
.login{width: 400px;height: 470px;/*border:1px solid #ff6700;*/margin:30px auto;background: #444;color:#fff;margin-right: 100px;border-radius: 4px;}
.login .login_center{width: 360px;margin: 30px auto;}
