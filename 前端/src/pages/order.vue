  ...
  <div class="order">
    ...
    <div class="grzxbj">
      <div class="selfinfo center">
          ...
          <div class="subddzx">
            <ul>
              <router-link to="order">
                <li>
                  <a style="color:#ff6700;font-weight:bold;">我的订单</a>
                </li>
              </router-link>
            </ul>
          </div>
        ...
        <div class="rtcont fr" style="overflow:scroll">
          ...
          <div class="pay" style="margin-left:40px;margin-bottom:10px;font-size:15px;">
            <a
              @click="findall2"
              ref="findall"
              style="color: orange;font-weight: 1000"
            >全部订单&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <span>|</span>
            <a
              @click="staypay"
          ...
          <div v-if="!this.orderlist">
            <div class="grzlbt ml40">当前暂无订单</div>
          </div>
          ...
          <div v-for="item in orderlist" :key="item">
            ...
            >
              &emsp;&emsp;&emsp;订单时间: {{formatDate(item.order_time)}} &emsp;订单号: {{item.order_num}} &emsp;&emsp;&emsp;总价： {{item.max_price}}元 &emsp;&emsp;&emsp;
              <br />
              &emsp;&emsp;&emsp;收货人： {{item.order_aceptman}} &emsp;&emsp;&emsp; 收获地址： {{item.order_address}} &emsp;&emsp;&emsp; 联系方式： {{item.order_phone}} &emsp;&emsp;&emsp;
              <span
              ...
              <span v-else>
                ...
                <el-button
                  ...
                  circle
                  @click="pay(item)"
                  style="float:right;margin-right:20px;margin-top:-16px;"
                  title="付款"
                ></el-button>
              </span>
              <el-button
    ...
    >
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="收件人" prop="order_aceptman" label-text-align="center">
          <el-input
        ...
        <el-form-item label="收货地址">
          <el-input
            ...
            size="mini"
            :placeholder="this.formdatd.order_address"
          ></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    Delete(order_num) {
      axios
        .post('/goods/Order_Delete/', { order_num: order_num })
        .then(result => {
          this.findAll()
          this.$notify.success({
            title: '删除订单成功',
    ...
    queding(form) {
      ...
      axios
        .post('/goods/Order_Update/', this.form)
        .then(result => {
          this.findAll()
          this.dialogVisible = false
    ...
    staypay() {
      this.$refs['findall'].style.color = 'gray'
      this.$refs['findall'].style['font-weight'] = 500
      this.$refs['staypay'].style.color = 'orange'
      this.$refs['staypay'].style['font-weight'] = 1000
      this.$refs['yifukuan'].style.color = 'gray'
      this.$refs['yifukuan'].style['font-weight'] = 500
    ...
    yifukuan() {
      this.$refs['findall'].style.color = 'gray'
      this.$refs['findall'].style['font-weight'] = 500
      this.$refs['yifukuan'].style.color = 'orange'
      this.$refs['yifukuan'].style['font-weight'] = 1000
      this.$refs['staypay'].style.color = 'gray'
      this.$refs['staypay'].style['font-weight'] = 500
      axios
        .get(
          '/goods/Order_List/?page=' +
            this.page +
    ...
    findall2() {
      this.$refs['findall'].style.color = 'orange'
      this.$refs['findall'].style['font-weight'] = 1000
      this.$refs['yifukuan'].style.color = 'gray'
      this.$refs['yifukuan'].style['font-weight'] = 500
      this.$refs['staypay'].style.color = 'gray'
      this.$refs['staypay'].style['font-weight'] = 500
