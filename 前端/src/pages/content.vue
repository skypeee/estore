<template>
  <div class="content">
    ...
    <div class="jieshao mt20 w">
      ...
      <div class="right fr">
        ...
        <div class="xzbb ml20 mt10">
          <div class="banben fl">
            <a>{{this.content.good_parameter}}</a>
          </div>
        ...
        <div class="xqxq mt20 ml20">
          <div class="top1 mt10">
            <div
              class="left1 fl"
            >{{this.content.good_name}} {{this.content.good_parameter}} {{this.color}}</div>
    ...
    <div class="response" style="margin:30px;">
      ...
      <div
        class="media response-info"
        v-for="(item,index) in commentlist"
        :key="item"
        style="border: 1px dotted #CDCCCC;padding:5px;"
      >
        <div class="media-left response-text-left">
          <h5 style="color:#F81800">
            第
            <span style="margin:2px;color:#9ae50c;">{{index+1}}</span>楼
          </h5>

          <h5>{{item.user.last_name}}</h5>
        </div>
        <div class="media-body response-text-right">
          <p v-html="item.comment_content" style="margin-top:10px;text-align:left;margin-left:15%;">
    ...
    <div class="Dialog">
      ...
      >
        <el-form :model="form" ref="form" class="demo-ruleForm">
          ...
          >
            <el-input disabled v-model="form.username" size="mini"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    findAll() {
      ...
      axios.get('/goods/Good_list/?id=' + this.id).then(result => {
        ...
        axios.get('goods/Comment_List/?good_id=' + this.id).then(result => {
          console.log(result)
