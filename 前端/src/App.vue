      ...
      <div class="top center">
        ...
        <div class="right fr">
          ...
          <div class="fr">
            ...
            <ul>
              <li><a @click="Login">{{this.login}}</a></li>
              ...
              <img :hidden='imghidden'
                   :src="this.user_img?this.user_img:'../static/index/images/icon1.png'"
                   alt=""
                   style="width:40px;height:40px;border-radius: 100%;border: 2px solid #fff;"
                   @click="personal">
  ...
  created () {
    axios.post('/wish/api-token-verify/', { 'token': Cookies.get('token') })
      .then((result) => {
        ...
        axios.get('/users/User_List/?search=' + this.user_id)
          .then((result) => {
            console.log(result)
            this.user_img = result.data[0].user_img
...
.banner_y {
  width: 1226px;
  height: 460px;
  background: url("./image/banner2.jpg") right;
}
.banner_y .nav {
  width: 234px;
  height: 460px;
