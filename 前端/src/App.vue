    ...
    <div class="App">
		...
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a  @click="shopping" >购物车</a></div>
					<div class="fr">
...
img{border:none;}
a{border:none;text-decoration: none;color:#000;cursor: pointer;}
...
.banner_x .nav ul li a:hover{color: rgb(255,103,0); }
 .search{width: 308px;height: 50px;line-height: 50px;margin-right:200px;}
 .search .text{width: 250px;height:30px;line-height: 30px;font-size: 12px;border:1px solid #ccc;}
 .search .text:hover{border-color: #ff6700;}
.search .text .shuru{border: none;width: 250px;height: 20px;}
 .search .submit{width: 50px;height:30px;line-height: 30px;text-align:center;font-size: 12px;border:1px solid #ccc;}
 .search .submit .sousuo{letter-spacing:3px;text-align:center;width: 50px;height:30px;border: none;background: none;cursor:pointer;}
 .search .submit:hover{border-color: #ff6700;color:#ff6700;} 
/*banner_y*/
.banner_y{width:1226px;height:460px;background: url('./image/banner2.jpg') right;}
.banner_y .nav{width: 234px;height: 460px;}
...
.banner_y .nav ul li .pop .left .xuangou_left a img{valign:middle;width: 50px;height: 50px;}
...
.banner_y .nav ul li .pop .ctn .xuangou_left a img{valign:middle;width: 50px;height: 50px;}
...
.banner_y .nav ul li .pop .right .xuangou_left a img{valign:middle;width: 50px;height: 50px;}
...
.danpin .main .mingxing{width: 234px;height: 339px;background: rgb(250,250,250);border-top: 1px solid orange;margin-top: 10px;}
...
.danpin .main .mingxing .youhui{width: 234px;height: 12px;line-height: 12px;margin:25px 0;font-size: 12px;color: rgb(176,176,176);text-align: center;}
.danpin .main .mingxing .jiage{font-size: 14px;text-align: center;color:#ff6709;margin-top: 30px;}
...
.xiangqing .neirong nav{display:inline-block;width: 800px;height: 58px;line-height: 58px;}
.xiangqing .neirong nav li{font-size:14px;float: left;overflow: hidden;margin:0px 5px;}
...
.jieshao .right .xzbb .banben{height: 58px;line-height: 58px;width: 500px;cursor:pointer;margin-right: 5px;border:1px solid #bbb;overflow: hidden;}
...
.jieshao .right .xzbb .banben a .yuandian{display: inline-block;height: 15px;width: 15px;border-radius: 50%;background: rgba(24, 41, 197);margin-left: 80px;}
/*选取详情*/
...
/*购物车详单*/
.gwcxqbj{width: 100%;height:400px;padding-bottom: 20px;}
