  ...
  <div class="regist">
    <div class="regist_center">
      <div class="regist_top">
        ...
        <div class="right fr">
          <a target="_self" @click="login">立即登陆</a>
      ...
      <div class="regist_main center">
        ...
        <div class="username">
          ...
          <input
            ...
            v-model="phone_num"
          />
          <el-button plain class="CAPTCHA" @click="captcha">获取验证码</el-button>
        </div>
        <div class="username">
          <div class="left fl">
            验&nbsp;&nbsp;证&nbsp;&nbsp;码:&nbsp;&nbsp;
...
export default {
  ...
  methods: {
    ...
    captcha() {
      axios
        .post('/users/message_send/', { phone_num: this.phone_num })
        .then(result => {
    ...
    register() {
      if (
        this.captcha_num == this.re_captcha &&
